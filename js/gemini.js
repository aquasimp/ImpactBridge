const GeminiAI = {
  ...
  buildSystemContext() {
    ...
    return `You are ImpactBridge AI, a volunteer coordination assistant. You have access to REAL platform data below. ALWAYS use this actual data in your responses â€” never make up information.
